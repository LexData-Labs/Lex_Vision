...
# This script helps set up Nginx with HTTPS for Lex Vision

Write-Host "🔒 Nginx HTTPS Setup for Lex Vision" -ForegroundColor Cyan
...
$nginxConfigTemplate = @"
# Nginx Configuration for Lex Vision
...
Write-Host "1. Make sure Lex Vision backend is running on port 8000" -ForegroundColor White
Write-Host "2. Make sure Lex Vision frontend is running on port 8080" -ForegroundColor White
